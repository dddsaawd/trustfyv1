...
export function KPICard({ label, value, change, changeLabel, tooltip, index = 0, syncing }: KPICardProps) {
      ...
      <TooltipTrigger asChild>
        ...
        >
          ...
          <div className="relative">
            ...
            {syncing ? (
              <p className="text-xs text-muted-foreground animate-pulse mt-1">Sincronizando Ads...</p>
            ) : (
              <>
